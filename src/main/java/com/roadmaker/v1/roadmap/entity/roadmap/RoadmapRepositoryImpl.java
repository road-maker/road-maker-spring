...
import static com.roadmaker.v1.roadmap.entity.roadmap.QRoadmap.roadmap;
import static com.roadmaker.v1.like.entity.QLike.like;
...
public class RoadmapRepositoryImpl extends QuerydslRepositorySupport implements RoadmapRepositoryCustom{
    ...
    public RoadmapFindResponse findBySearchOption(PageRequest pageRequest, String keyword) {
        ...
        Page<RoadmapDto> roadmapDtoPage = new PageImpl<>(roadmapDtos, pageRequest, query.fetchCount());
